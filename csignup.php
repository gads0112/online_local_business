...
<head>
    ...
    <style>
          body  {
    background-image: url("img/taxes.webp" );
...
<body >
	...
	<div class="row" style="text-align: center;">
		...
		<div class="col-md-6 well">
            ...
            <legend style="background-color: white; color: black; padding-bottom: 25px;text-align: center;padding-top: 25px;font-size: 30px;font-weight: normal;font-family: verdana"><span class="glyphicon glyphicon-user"> </span> &nbsp;Customer Sign Up</legend>
            <hr class="colorgraph">

		<form class="form-horizontal" name="form" action="csignupphp.php" method="POST">
<fieldset>
...
<div class="form-group">
  ...
  <div class="col-md-8">
  <input id="customer" name="username" placeholder="Enter your name" class="form-control input-md" type="text" required 
        >
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="mob">Mobile Number<span style="color:red;font-size: 20px;"> * </span> : </label>  
  <div class="col-md-8">
  <input id="customer" name="mobile" placeholder="ex:- 9999999999" class="form-control input-md" type="text" maxlength="10" pattern="[1-9]{1}[0-9]{9}" required >
  </div>
</div>
    </div>
...
<div class="form-group">
  ...
  <div class="col-md-12"> 
    <input  type="submit" id="submit" class="btn btn-primary" value="Register"/><span class="glyphicon glyphicon-sign-up"></span>
  </div>
</div>
